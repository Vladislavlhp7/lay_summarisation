...
class AMParserConfig:
    ...
    build_numericalizer_on_entire_corpus: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Builds numericalizer from the ftrain, fvalid and ftest files."
        },
    )
    ...
    split_document: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to split overlength text into multiple segments"
    ...
    evaluate_with_oracle_span: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to evaluate node labels and edges with oracle spans."
        },
    )
    ...
    lambda_proposition: Optional[float] = field(
        default=1.0,
        metadata={
            "help": "The loss weight for node labeling (component classification)"
        },
    )
