...
from laysummarisation.model.extractor_model import generate_summary
from laysummarisation.utils import remove_citations


def perform_inference(
    model, tokenizer, article: str, max_length: int = 512, top_k: int = 25
):
    """
