...
class BaseTrainer:
    ...
    def run_train(
        ...
        # def _get_entire_key_value_in_dict(
        #     _d: Dict, _key_chain: str = ""
        ...
        #         else:
        #             _chains += _get_entire_key_value_in_dict(
        #                 _v, f"{_key_chain}/{_k}" if _key_chain else _k
        #             )
        #     return _chains
        #
        # # Training epochs
        ...
        #                     f"val_metric/{keychain}", v, self.current_step
        #                 )
        #
        ...
        #             valid_eval_file,
        #             content=json.dumps(
        #                 {"scores": val_scores, "epoch": epoch}, ensure_ascii=False
        #             ),
        #         )
        #
        ...
        #     else:
        #         logging.warning(
        #             f"[Valid] There is no validation set,"
        ...
        #     if val_f >= best_f:
        #         logging.info(
        #             f"[Valid] Update the best model based on the validation score"
        #         )
        ...
        #             if (
        #                 len(test_loader) == 0
        #                 and not self.config.disable_saving_large_files
        #             ):
        #                 valid_metric.dump_metric_data(
        #                     save_dir=os.path.join(
        #                         self.config.log, f"progress/valid/epoch={epoch}/"
        #                     ),
        #                     max_num=10,
        #                 )
        #             valid_metric.dump_pred_mrp(save_path=predicted_valid_file)
        #             logging.info(
        #                 f'[Valid] Saved validation prediction at "{predicted_valid_file}"'
        #             )
        #
        #         # Do test prediction
        ...
        #                     save_dir=os.path.join(
        #                         self.config.log, f"progress/test/epoch={epoch}/"
        #                     ),
        #                     max_num=30,
        #                 )
        #
        ...
        #                 test_eval_file,
        #                 content=json.dumps(
        #                     {"scores": test_scores, "epoch": epoch}, ensure_ascii=False
        #                 ),
        #             )
        #
        ...
        #             logging.info(
        #                 f'[Test] Saved test prediction at "{predicted_test_file}"'
        #             )
        #             if self.tb_writer:
        #                 for keychain, v in _get_entire_key_value_in_dict(test_scores):
        #                     self.tb_writer.add_scalar(
        #                         f"test_metric/{keychain}", v, self.current_step
        #                     )
        #
        ...
        #     finished_file,
        #     content=json.dumps(
        #         {"best_f": best_f, "best_epoch": best_e}, ensure_ascii=False
        #     ),
        # )
        # return
